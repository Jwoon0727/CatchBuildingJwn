...
export default function PropertyDescription() {
  return (
    <div className="bg-white rounded-lg border border-border p-6 mb-6">
      <h3 className="font-bold text-lg text-foreground mb-4">매물 상세 설명</h3>

      {/* Summary */}
      <div className="mb-6">
        <h4 className="font-bold text-foreground mb-2">매물 개요</h4>
      ...
      {/* Checkpoints */}
      <div className="mb-6">
        <h4 className="font-bold text-foreground mb-2">체크 포인트</h4>
      ...
      <div className="bg-secondary/30 rounded-lg p-4">
        <h4 className="font-bold text-foreground mb-2">중개사 코멘트</h4>
        <p className="text-sm text-muted-foreground leading-relaxed">
          백현동에서 이 위치가지를 갖춘 이전 빌딩을 신규별 가격에 사입시 힙습니다.
          전층 순 수익 법인 빈번이 가동하고도 7-8년 만 설치가 타마(비 업지 시시이가 약 1,840 상승한 지역으로 왕
          후 가지 상승 아직도 유망전 합니다.
        </p>
      </div>
    </div>
